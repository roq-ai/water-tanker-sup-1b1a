...
import { useSupplierFindFirst, useRoqClient } from 'lib/roq';
...
function SupplierViewPage() {
  ...
  const { data, error, isLoading } = useSupplierFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('supplier', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/suppliers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="supplier" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
