...
import { useCustomerFindFirst, useRoqClient } from 'lib/roq';
...
function CustomerViewPage() {
  ...
  const { data, error, isLoading } = useCustomerFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('customer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/customers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Contact Number" text={data?.contact_number} />
