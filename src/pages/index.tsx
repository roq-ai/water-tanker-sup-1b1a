...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Water Tanker Supplier `}</title>

        <meta
          name="description"
          content="Water Tanker Supplier - Providing reliable water transportation solutions to industrial sites. Ensuring your operations never run dry, one tanker at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1635884517464-c7bf09499bea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3YXRlciUyMHRhbmtlcnxlbnwwfHx8fDE2OTc1NDE2NzN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@valdee3?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Valtteri Laukkanen`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Water Tanker Supplier - Providing reliable water transportation solutions to industrial sites. Ensuring your operations never run dry, one tanker at a time.`}
            </Text>
            <Box
