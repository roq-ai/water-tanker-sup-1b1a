...
import { useBusinessOwnerFindFirst, useRoqClient } from 'lib/roq';

import { BusinessOwnerInterface } from 'interfaces/business-owner';

function BusinessOwnerViewPage() {
  ...
  const { data, error, isLoading } = useBusinessOwnerFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('business_owner', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/business-owners/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Business Name" text={data?.business_name} />

                <FormListItem label="Business Address" text={data?.business_address} />

                <FormListItem label="Business Contact" text={data?.business_contact} />
